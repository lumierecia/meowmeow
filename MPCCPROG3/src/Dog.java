...
/**
 * The Dog class represents a Dog piece in the game and extended from Piece
 *
 */
public class Dog extends Piece {
    /**
     * Constructs a Dog piece with the given position and player.
     *
     * @param x       The initial x-coordinate of the Dog.
     * @param y       The initial y-coordinate of the Dog.
     * @param player  The player to whom the Dog belongs.
     */
    public Dog(int x, int y, Player player) {
        super("Dog", x, y, player, PieceType.Dog);
    }
    /**
     * Moves the Dog in the specified direction on the board.
     * The Dog can move up (W), left (A), down (S), or right (D).
    ...
    public boolean move(char direction, Board board) {
        ...
        if (destinationSquare != null) {
            ...
            // Capture the opponent's piece if possible
